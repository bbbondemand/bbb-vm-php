...
class YourClassTest extends TestCase
{
	...
	public function setUp()
	{
		...
		foreach (['VM_CUSTOMER_ID', 'VM_CUSTOMER_API_TOKEN', 'VM_API_URL', 'VM_START_INSTANCE_NAME', 'VM_STOP_INSTANCE_NAME', 'VM_DELETE_INSTANCE_NAME', 'VM_INSTANCE_NAME'] as $k) {
			if (!getenv($k)) {
		...
		$this->urlBuilder = new BBBondemand\Util\UrlBuilder($this->customer_id, $this->customer_api_token, $this->baseUrl);
		$this->vm = new BBBondemand\VM();
	}
	...
	*/
	 ...
	 */
	public function testStartInstanceByName()
	{
	 ...
	 * Test start instance by name
	 */
	public function testStopInstanceByName()
	{
	 ...
	 * Test start instance by name
	 */
	public function testDeleteInstanceByName()
	{
	 ...
	 */
	public function testMatchInstancesListArrayStructure()
	{
	 ...
	 */
	public function testMatchInstanceByNameArrayStructure()
	{
	 ...
	 */
	public function testMatchRegionsArrayStructure()
	{
	 ...
	 */
	public function testMatchMeetingsArrayStructure()
	{
	 ...
	 */
	public function testExecuteGetApiCall()
	{
	 ...
	 */
	public function testExecuteDeleteApiCall()
	{
